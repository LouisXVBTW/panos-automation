      ...
      "management" = {
        ...
        rules = {
          mgmt_inbound = {
            ...
            access                     = "Allow"
            protocol                   = "Tcp"
            source_address_prefixes    = ["86.18.52.140/32"] # TODO: Whitelist IP addresses that will be used to manage the appliances
            source_port_range          = "*"
          ...
          "app1" = {
            ...
            rules = {
              ...
              web_inbound = {
                ...
                access                     = "Allow"
                protocol                   = "Tcp"
                source_address_prefixes    = ["86.18.52.140/32"] # TODO: Whitelist public IP addresses that will be used to access test infrastructure
                source_port_range          = "*"
